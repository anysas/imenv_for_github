    ...
    public class DitheringRenderFeature : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ditheringPass = new DitheringPass(
                ...
                PsxPostEffectShaders.ResolveDithering(ditheringShader));
        }
...
#pragma warning restore CS0618
    ...
    public class DitheringPass : ScriptableRenderPass
    {
        ...
        public DitheringPass(RenderPassEvent evt, Shader shader)
        {
            renderPassEvent = evt;
            if (shader == null)
            {
                Debug.LogError("[PSX] Dithering shader is missing.");
                return;
            }
