    ...
    public class PixelationRenderFeature : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            pixelationPass = new PixelationPass(
                ...
                PsxPostEffectShaders.ResolvePixelation(pixelationShader));
        }
...
#pragma warning restore CS0618
    ...
    public class PixelationPass : ScriptableRenderPass
    {
        ...
        public PixelationPass(RenderPassEvent evt, Shader shader)
        {
            renderPassEvent = evt;
            if (shader == null)
            {
                Debug.LogError("[PSX] Pixelation shader is missing.");
                return;
            }
