...
namespace AlgorithmicGallery.Corruption
{
    ...
    public static class PropScaler
    {
        ...
        public static float ComputeScaleFactor(PropEntry prop, float sceneMultiplier)
        {
            ...
            if (longest < 0.001f)
            {
                // RandomObjects: SculptureSpawner already normalizes mesh size — only apply scene tuning.
                return Mathf.Clamp(sceneMul, MinScaleFactor, MaxScaleFactor);
            }
